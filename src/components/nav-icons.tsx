/**
 * Inline SVG icon components for the portal sidebar navigation.
 * All icons are decorative (aria-hidden) — the parent <Link> provides
 * the accessible label via its visible text content.
 */
...
/** Maps a nav href to its icon component. */
export const NAV_ICON_MAP: Record<string, React.ComponentType> = {
